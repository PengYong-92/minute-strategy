...
class SimulatorTest(unittest.TestCase):
    ...
    def test_stats_reports_trading_day_orders_from_shanghai_0800(self):
        ...
        settle_at(timestamp_ms(10, 7, 59, 59), won=True)
        settle_at(timestamp_ms(10, 8), won=False)
        settle_at(timestamp_ms(10, 11, 30), won=True)
        settle_at(timestamp_ms(11, 8), won=True)
    ...
    def test_stats_before_shanghai_0800_uses_previous_trading_day(self):
        shanghai = timezone(timedelta(hours=8))
        ...
        settle_at(timestamp_ms(9, 7, 59), won=True)
        settle_at(timestamp_ms(9, 8), won=True)
        settle_at(timestamp_ms(10, 7, 59), won=False)
        settle_at(timestamp_ms(10, 8), won=True)

        stats = simulator.stats(now_ms=timestamp_ms(10, 7, 59))
